...
export default new (class newPuppeteer {
  ...
  async launch () {
    ...
    this.browser.on('disconnected', (e) => {
      logger.error('[止水]Chromium实例关闭或崩溃！')
      this.browser = false
    })
  ...
  async render (path, params, cfg) {
    ...
    let data = {
      ...
      sys: {
        ...
        copyright: `Created By Yunzai-Bot<span class="version">${Version.yunzai}</span> & zhishui-Plugin<span class="version">${Version.ver}</span>`
      },
      quality: 100
    }
