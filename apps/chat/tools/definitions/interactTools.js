            ...
            parameters: {
                ...
                properties: {
                    meme_type: {
                        type: "string",
                        description: "表情包类型",
                        "enum": ["petpet", "crawl", "kiss", "rub", "play", "pat", "punch", "always", "jump", "eat", "my_friend", "bite", "support", "throw"]
                    },
                    user_id: {
                        type: "string",
                    ...
                    text: {
                        type: "string",
                        description: "文字。my_friend必填名字；petpet可选'圆'；always可选'循环'或'套娃'；crawl可选数字"
                    }
                },
