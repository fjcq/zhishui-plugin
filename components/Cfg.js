...
const _cfgPath = `${_path}/plugins/zhishui-plugin/components/`
let cfg = {}

let configPath = `${_path}/plugins/zhishui-plugin/config/`
let defSetPath = './plugins/zhishui-plugin/defSet/'
