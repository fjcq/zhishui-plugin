                    ...
                    componentProps: {
                        ...
                        schemas: [
                            ...
                            },
                            {
                                ...
                                label: '编辑JSON数据',
                                component: 'InputTextArea',
                                bottomHelpMessage: '点击编辑框查看和修改角色的完整JSON配置数据，支持复制粘贴。内容会根据_original字段自动填充，或从表单字段构建。',
                                componentProps: {
                                    autoSize: { minRows: 8, maxRows: 15 },
                                    placeholder: '点击此处查看和编辑角色的JSON数据...',
                                    style: {
