...
const TOOL_CATEGORIES = [
    {
        ...
        tools: [
            ...
            { value: 'set_user_favor', label: '设置好感度', desc: '精确设置好感度值' },
            { value: 'get_user_info', label: '获取用户信息', desc: '获取用户详细数据' },
            { value: 'get_group_info', label: '获取群信息', desc: '获取群组基本信息' },
            { value: 'get_user_profile', label: '获取QQ资料', desc: '获取用户QQ资料' },
            { value: 'get_group_members', label: '获取群成员', desc: '获取群成员列表' }
        ]
    },
    {
        label: '好友工具',
    ...
    },
    {
        ...
        tools: [
            ...
            { value: 'set_group_card', label: '修改群名片', desc: '修改群成员名片（需Bot是管理员）' },
            { value: 'set_group_title', label: '设置专属头衔', desc: '设置群成员专属头衔（需Bot是群主）' },
    ...
    },
    {
        ...
        tools: [
            ...
            { value: 'get_lyrics', label: '获取歌词', desc: '获取歌曲歌词' },
            { value: 'get_playlist', label: '获取歌单', desc: '获取歌单内容' }
        ]
    },
    {
        label: '消息工具',
        tools: [
            ...
            { value: 'send_voice', label: '发送语音', desc: '发送语音消息' },
            { value: 'send_private_message', label: '发送私聊', desc: '发送私聊消息' },
            { value: 'send_group_message', label: '发送群消息', desc: '发送群消息到指定群组' },
            { value: 'forward_message', label: '转发消息', desc: '转发消息到其他群' },
            { value: 'recall_message', label: '撤回消息', desc: '撤回消息' },
    ...
    },
    {
        ...
        tools: [
            ...
            { value: 'forget_user_info', label: '删除记忆', desc: '删除记忆库中的用户信息' },
            { value: 'set_reminder', label: '设置提醒', desc: '为用户设置提醒' },
            { value: 'get_reminders', label: '获取提醒', desc: '获取用户的提醒列表' },
            { value: 'cancel_reminder', label: '取消提醒', desc: '取消用户的提醒' },
            { value: 'record_interaction', label: '记录互动', desc: '记录与用户的重要互动' },
            { value: 'get_interaction_history', label: '获取互动历史', desc: '获取与用户的历史互动记录' }
        ]
    },
    {
        label: '输出工具',
