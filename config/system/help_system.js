...
export const helpList = [
    ...
    },
    {
        ...
        "list": [
            ...
            { "icon": 22, "title": "#好感度排名", "desc": "查看好感度排行榜" },
            { "icon": 92, "title": "#清空好感度", "desc": "清空所有好感度数据" }
        ]
    },
    {
        "group": "API配置",
    ...
    },
    {
        ...
        "list": [
            ...
            { "icon": 29, "title": "#设置主人<QQ>", "desc": "设置主人身份(主人)" }
        ]
    },
    {
        "group": "调试工具",
        "list": [
            ...
            { "icon": 83, "title": "#查看上下文模式", "desc": "查看当前存储模式" },
            { "icon": 29, "title": "#切换模式<角色/场景>", "desc": "切换上下文存储模式" }
        ]
    },
    {
        "group": "搜剧功能",
    ...
    },
    {
        "group": "乐器演奏",
        "list": [
            { "icon": 97, "title": "#演奏<乐器>+简谱|节奏", "desc": "演奏音乐(支持钢琴/八音盒/古筝等)" },
            { "icon": 81, "title": "#取消演奏", "desc": "取消当前演奏" },
            { "icon": 85, "title": "#高品质演奏开启/关闭", "desc": "切换高品质模式(主人)" }
        ]
    },
    {
        "group": "插件管理",
        "auth": "master",
        "list": [
            { "icon": 50, "title": "#止水版本", "desc": "查看插件版本信息" },
            { "icon": 85, "title": "#止水更新", "desc": "更新插件" },
            { "icon": 85, "title": "#止水强制更新", "desc": "强制更新插件" },
            { "icon": 83, "title": "#止水更新日志", "desc": "查看更新日志" }
        ]
    }
]
